...
alias make-release-fw='cmake --preset "ReleaseFW"'
alias make-zip-fw='cmake --build build --target FirmwareReleaseFW'
alias make-all-build-fw='del-sdkconfig; make-fullclean; make-release-fw; make-build'
alias make-all-zip-fw='del-sdkconfig; make-fullclean; make-release-fw; make-zip-fw'
